#include <stdio.h> //biblioteca padrï¿½o
#include <stdlib.h> //biblioteca que usa de alocaï¿½ï¿½o de espaï¿½o em memï¿½ria
#include <locale.h> //biblioteca de alocaï¿½ï¿½o de tete por regiï¿½o
#include <string.h> //biblioteca de string

int registro()
{
	//iniciando variï¿½veis e tamanho
	char arquivo[40];
	char cpf[40]; 
	char nome[40];
	char sobrenome[40];
	...
	fclose(file); //fechar a funï¿½ï¿½o de arquivo
...
int consulta()
{
	...
	while(fgets(conteudo,200,file) != NULL) //Laï¿½o para rodar atï¿½ condiï¿½ï¿½o de falso
	{
...
int main()
{
	...
	for (x=1;x=1;)
	{
		...
		system("cls"); //Limpar tela dos itens jï¿½ escritos
